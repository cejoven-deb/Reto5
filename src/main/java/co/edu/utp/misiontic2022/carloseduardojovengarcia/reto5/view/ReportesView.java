...
package co.edu.utp.misiontic2022.carloseduardojovengarcia.reto5.view;

import co.edu.utp.misiontic2022.carloseduardojovengarcia.reto5.controller.ReportesController;
...
public class ReportesView {
    ...
    public void totalAdeudadoPorProyectosSuperioresAlLimite(Double limiteInferior){
        System.out.println(
        ...
        public void lideresQueMasGastan(){
            System.out.println(
                repitaCaracter('=', 6) + " 10 LIDERES QUE MAS COMPRAN " +
                repitaCaracter('=', 7)
            );
